...
if __name__ == "__main__":
    ...
    # 第一个 if True 为冻结训练，即设定 param.requires_grad = False 防止通过梯度下降计算网络参数
    r'''
    冻结训练的相关信息：
        https://www.cxyzjd.com/article/yanghao201607030101/109898944
    ...
    # 第二个 if True 为解冻训练，即设定 param.requires_grad = True 正常训练网络
    if True:
        lr              = 1e-5
        Interval_Epoch  = 50
        Epoch           = 100
