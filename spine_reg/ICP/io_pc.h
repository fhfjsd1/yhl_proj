...
///--- 用 vertices 的内容替换 prev_filename 中的顶点，并保存到 filename
template <class MatrixType>
...
template <class MatrixType>
bool read_file(MatrixType& vertices, MatrixType& normals, MatrixType& vert_colors,const std::string& filename) {
